...
public class InformationWindow extends JPanel {
    ...
    public InformationWindow(ControlPanel control, ArrayList<Person> clientList,
             ...
             HashMap<String, Street> sidewalkMap, HashMap<String, Street> roadMap, HashMap<String, 
                     ImageIcon> images, JLabel background) {
        ...
        clientDataField.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                control);
                ObjectListener clientListener = new ObjectListener(newC, infWindow, images);
        ...
        supplierDataField.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                route.add(0);route.add(1);route.add(10);
                ...
                ObjectListener supplierListener = new ObjectListener(newS, infWindow, images);
    ...
    public void refreshWholesaleStore(WholesaleStoreThread wholesaleStoreThread, HashMap<String, ImageIcon>images) {
        ...
        addProductField.setText("ID, name, brand, date");
        ...
        addProductField.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String[] inputs = input.split(", ");
                wholesaleStore.createProduct(Integer.parseInt(inputs[0]), inputs[1], inputs[2], inputs[3]);             
            }
        });
    }
